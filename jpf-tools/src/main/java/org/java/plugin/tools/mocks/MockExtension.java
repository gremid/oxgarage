...
/**
 * @version $Id: MockExtension.java,v 1.3 2007/06/02 12:01:29 ddimon Exp $
 */
public class MockExtension extends MockPluginElement<Extension>
    ...
    /**
     * @see org.java.plugin.registry.Extension#isOptional()
     */
     ...
     * @return this instance
     */
    public MockExtension setOptional(final boolean value) {
        isOptional = value;
        return this;
    }
